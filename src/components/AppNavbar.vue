  ...
  >
    <div class="container navbar__inner">
      ...
      <div class="navbar__actions">
        ...
        <router-link to="/doctors" class="btn-book"> Book Now </router-link>
      </div>
...
.btn-book:hover {
  ...
  box-shadow: 0 6px 20px rgba(10, 177, 237, 0.45);
}
...
.slide-down-leave-active {
  animation: slideDownIn 0.2s ease-out reverse;
}
