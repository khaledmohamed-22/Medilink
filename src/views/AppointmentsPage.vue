        ...
        <div class="appt-card" v-if="doctor">
          ...
          <div class="appt-card__header">
            ...
            <div>
              ...
              <p class="appt-card__subline">
                Your booking is secured. See you soon.
              </p>
            </div>
          </div>
          ...
          <div class="doctor-summary">
            ...
            <div class="doctor-summary__info">
              ...
              <span class="doctor-summary__specialty">{{
                doctor.specialty
              }}</span>
            </div>
          </div>
          ...
          <div class="details-grid">
            ...
            <div class="detail-item">
              <div class="detail-item__icon detail-item__icon--green">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M12 2l7 3v5c0 4.97-3.22 9.57-7 11C5.22 19.57 2 14.97 2 10V5l10-3z"
                    stroke="currentColor"
                    stroke-width="1.8"
                  />
                </svg>
              ...
              <div>
                ...
                <span class="detail-item__value detail-item__value--green"
                  >Confirmed</span
                >
              </div>
            </div>
          ...
          <div class="appt-notice">
            ...
            <p>
              A confirmation has been sent to your registered email. Please
...
:root {
  ...
  --radius-lg: 22px;
  --shadow-card: 0 8px 40px rgba(13, 27, 42, 0.1);
}
...
.btn--primary:hover {
  ...
  box-shadow: 0 8px 24px rgba(10, 177, 237, 0.4);
}
.btn--secondary {
...
.empty-card__circle {
  ...
  border-radius: 50%;
  background: var(--teal-light);
  border: 2px dashed rgba(10, 177, 237, 0.3);
  display: grid;
  place-items: center;
  margin: 0 auto 28px;
  color: var(--teal);
...
.pop-leave-active {
  animation: popOut 0.3s ease both;
}
@keyframes popIn {
  from {
    opacity: 0;
...
.fade-leave-active {
  animation: fadeUp 0.3s ease-out reverse both;
}
@keyframes fadeUp {
  from {
    opacity: 0;
