    ...
    <div class="page-header">
      ...
      <div class="container page-header__inner">
        ...
        <p class="page-header__sub">
          Every doctor on MediLink is board-certified, reviewed, and ready to care for you.
        </p>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <transition name="fade">
          <div class="empty-state" v-if="filteredDoctors.length === 0">
            ...
            <button class="btn btn--secondary" @click="searchText = ''">Clear Search</button>
          </div>
        </transition>
        ...
        <div class="doctors-grid" v-if="filteredDoctors.length > 0">
          ...
          >
            <div class="doctor-card__img-wrap">
              <img :src="doctor.image" :alt="doctor.name" class="doctor-card__img" />
...
export default {
  ...
  setup() {
    ...
    const doctors = ref([
      { id: 1, name: "Dr. Sarah Johnson",  specialty: "Dentist",        rating: "4.9", exp: 12, image: require("../assets/doc1.jpg") },
      { id: 2, name: "Dr. Ahmed Hassan",   specialty: "Cardiologist",   rating: "4.8", exp: 18, image: require("../assets/doc7.jpg") },
      { id: 3, name: "Dr. Emily Carter",   specialty: "Dermatologist",  rating: "4.9", exp: 9,  image: require("../assets/doc2.jpg") },
      { id: 4, name: "Dr. Maged Ibrahim",  specialty: "Pediatrician",   rating: "4.7", exp: 14, image: require("../assets/Gemini_Generated_Image_h4p8qeh4p8qeh4p8.png") },
      { id: 5, name: "Dr. Nour",           specialty: "Neurologist",    rating: "4.8", exp: 11, image: require("../assets/doc4.jpg") },
      { id: 6, name: "Dr. David Lee",      specialty: "Orthopedic",     rating: "4.9", exp: 16, image: require("../assets/doc6.jpg") },
    ]);
...
.doctors-page { font-family: var(--font-body); color: var(--text-primary); background: var(--surface); min-height: 100vh; }
...
.page-header__title em { font-style: italic; color: var(--teal); }
.page-header__sub {
...
.search-box__icon {
  position: absolute; left: 20px; color: var(--text-secondary); flex-shrink: 0;
}
.search-box__input {
...
/* ─── DOCTORS BODY ─── */
.doctors-body { padding: 56px 0 80px; }
...
.doctor-card.in-view { opacity: 1; transform: scale(1) translateY(0); transition-duration: 0.55s; }
...
.doctor-card:hover .doctor-card__img { transform: scale(1.05); }
...
.doctor-card__body { padding: 24px 26px 28px; }
...
.doctor-card__exp {
  ...
  background: var(--surface); padding: 3px 10px; border-radius: 20px;
}

.doctor-card__name {
  font-family: var(--font-display); font-size: 1.25rem;
  font-weight: 700; color: var(--navy); margin-bottom: 4px; line-height: 1.2;
}
.doctor-card__specialty {
  font-size: 0.88rem; color: var(--teal); font-weight: 500; margin-bottom: 14px;
}
.doctor-card__availability {
  display: flex; align-items: center; gap: 7px;
  font-size: 0.8rem; color: #16a34a; font-weight: 500; margin-bottom: 20px;
}
.availability-dot {
...
@media (max-width: 768px) {
  ...
  .search-band { position: static; }
}
@media (max-width: 480px) {
  .doctors-grid { grid-template-columns: 1fr; }
  .doctor-card__img-wrap { height: 200px; }
}
</style>
