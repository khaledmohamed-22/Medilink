<template>
  <div class="booking-page">
    ...
    <section class="booking-hero">
      <div class="booking-hero__bg-grid" aria-hidden="true"></div>
      <div class="container booking-hero__inner">
        ...
        <div class="booking-hero__text">
          ...
          <h1 class="booking-hero__title">
            Reserve Your<br /><em>Appointment</em>
          </h1>
          <hr class="booking-hero__rule" />

          <div class="doctor-profile" v-if="doctorName">
            <div class="doctor-profile__info">
              <p class="doctor-profile__label">You're booking with</p>
              <h2 class="doctor-profile__name">{{ doctorName }}</h2>
              <span class="doctor-profile__specialty">{{ doctorSpecialty }}</span>
            </div>
          </div>

          <p class="booking-hero__desc">
            MediLink makes it simple to find the right specialist and secure
            your slot in minutes — no phone calls required.
          </p>
          ...
          <div class="booking-hero__actions">
            ...
            <a href="tel:+201234567890" class="btn btn--ghost">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div class="booking-hero__visual">
          <div class="doctor-img-card">
            <img
              v-if="doctorImage"
              :src="doctorImage"
              alt="Doctor"
              class="doctor-img-card__img"
            />
            <img
              v-else
              src="../assets/doc.png"
              ...
              class="doctor-img-card__img"
            />
            <div class="doctor-img-card__badge">
        ...
        <div class="form-card">
          <div class="form-card__header">
            ...
            <div>
              ...
              <p class="form-card__sub">Fill in the fields below to confirm your slot.</p>
            </div>
          </div>

          <form @submit.prevent="onclick" novalidate>
            <div class="form-row">
              <div class="form-group">
                <label class="form-label" for="name">Full Name</label>
                <div class="input-wrap">
                  <svg class="input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none">
                    <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" stroke="currentColor" stroke-width="1.7"/>
              ...
              <div class="form-group">
                ...
                <div class="input-wrap">
                  ...
                  <input
                    id="number" type="tel" class="form-control" required
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <div class="input-wrap input-wrap--select">
                  ...
                  <select id="time" class="form-control form-select" v-model="appointmentTime" required>
            ...
            <div class="form-group">
              ...
              <textarea
                id="notes" class="form-control form-textarea" rows="4"
                placeholder="Describe your symptoms or any special requirements (optional)"
              ></textarea>
            </div>
            ...
            <div class="trust-row">
              <div class="trust-item">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2l7 3v5c0 4.97-3.22 9.57-7 11C5.22 19.57 2 14.97 2 10V5l10-3z" stroke="currentColor" stroke-width="1.6"/>
                </svg>
                Secure & encrypted
              </div>
              <div class="trust-item">
              ...
              <div class="trust-item">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
                  <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" stroke="currentColor" stroke-width="1.6"/>
                </svg>
...
export default {
  ...
  setup() {
    ...
    return { doctorId, doctorName, doctorSpecialty, doctorImage, appointmentTime, onclick };
  },
};
</script>
...
:root {
  ...
  --radius-lg: 20px;
  --shadow-card: 0 4px 32px rgba(13,27,42,0.09);
}

*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
.booking-page { font-family: var(--font-body); color: var(--text-primary); background: var(--surface); }
...
.btn--primary:hover { background: var(--teal-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(10,177,237,0.4); }
...
.btn--submit {
  ...
  font-size: 1rem; background: var(--teal); color: #fff;
  box-shadow: 0 4px 20px rgba(10,177,237,0.3); border-radius: 14px;
  margin-top: 8px;
}
.btn--submit:hover { background: var(--teal-dark); transform: translateY(-2px); box-shadow: 0 8px 28px rgba(10,177,237,0.4); }

/* ─── HERO ─── */
.booking-hero {
  position: relative; overflow: hidden;
  background: linear-gradient(140deg, #0d2c45 0%, #0a3d5c 55%, #0d1b2a 100%);
  padding: 100px 0 80px; color: #fff;
}
.booking-hero__bg-grid {
...
.eyebrow {
  ...
  background: rgba(10,177,237,0.12); border: 1px solid rgba(10,177,237,0.25);
...
.booking-hero__title {
  ...
  animation: fadeUp 0.6s 0.06s ease-out both;
}
.booking-hero__title em { font-style: italic; color: var(--teal); }
.booking-hero__rule {
  width: 64px; height: 2px; background: var(--teal);
  border: none; margin: 0 0 24px;
...
.doctor-profile {
  ...
  padding: 18px 22px; margin-bottom: 22px; display: inline-block;
  animation: fadeUp 0.6s 0.14s ease-out both;
}
...
.doctor-profile__specialty {
  ...
  background: rgba(10,177,237,0.15); padding: 3px 10px; border-radius: 20px;
}
...
/* ── Doctor Image Card ── */
.booking-hero__visual { display: flex; justify-content: center; animation: fadeLeft 0.7s 0.3s ease-out both; }
.doctor-img-card {
  position: relative; border-radius: 24px; overflow: hidden;
  width: 100%; max-width: 380px;
  background: linear-gradient(135deg, rgba(10,177,237,0.2), rgba(10,177,237,0.05));
  border: 1px solid rgba(255,255,255,0.12);
  box-shadow: 0 20px 60px rgba(0,0,0,0.3);
  transition: transform 0.4s ease;
}
.doctor-img-card:hover { transform: translateY(-6px) scale(1.01); }
.doctor-img-card__img {
  width: 100%; height: 380px; object-fit: cover; object-position: top;
  display: block;
}
.doctor-img-card__badge {
  position: absolute; bottom: 18px; left: 50%; transform: translateX(-50%);
  background: rgba(16,185,129,0.15); border: 1px solid rgba(16,185,129,0.3);
  color: #34d399; backdrop-filter: blur(8px);
  font-size: 0.78rem; font-weight: 600; padding: 7px 16px; border-radius: 50px;
  display: flex; align-items: center; gap: 6px; white-space: nowrap;
}

/* ─── FORM SECTION ─── */
.form-section { padding: 60px 0 80px; background: var(--surface); }
...
.form-card__sub { font-size: 0.875rem; color: var(--text-secondary); }
...
.form-group:not(:in(.form-row)) { margin-bottom: 20px; }
...
.input-wrap--select .input-icon { z-index: 1; }
...
.form-textarea {
  padding: 13px 16px; resize: vertical; min-height: 100px;
}
...
@media (max-width: 992px) {
  ...
  .booking-hero__visual { order: -1; }
  .doctor-img-card { max-width: 320px; }
  .doctor-img-card__img { height: 280px; }
...
@media (max-width: 640px) {
  ...
  .booking-hero__actions { flex-direction: column; align-items: flex-start; }
